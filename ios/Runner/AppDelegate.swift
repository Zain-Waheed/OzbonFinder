...
//     BTAppContextSwitcher.setReturnURLScheme("com.ozbonfinder.flutterapp.braintree")
...
//     if url.scheme?.localizedCaseInsensitiveCompare("com.ozbonfinder.flutterapp.braintree") == .orderedSame {
