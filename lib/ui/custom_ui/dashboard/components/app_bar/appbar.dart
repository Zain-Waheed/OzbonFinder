...
class CustomDashboardAppBar extends StatelessWidget implements PreferredSizeWidget {
  const CustomDashboardAppBar(
      {required this.appBarTitle, required this.appBarTitleName, required this.currentIndex,required this.updateCurrentIndex,
  ...
  Widget build(BuildContext context) {
    return DashboardAppBar(appBarTitle: appBarTitle, appBarTitleName: appBarTitleName,
