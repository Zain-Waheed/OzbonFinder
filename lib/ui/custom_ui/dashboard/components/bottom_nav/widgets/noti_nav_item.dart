...
import 'package:psxmpc/ui/vendor_ui/dashboard/components/bottom_nav/widgets/noti_nav_item.dart';

class CustomNotiNavCount extends StatefulWidget {
  const CustomNotiNavCount(
...
class NotiNavCountState<T extends CustomNotiNavCount>
  ...
  Widget build(BuildContext context) {
    return NotiNavCount(updateSelectedIndexWithAnimation: widget.updateSelectedIndexWithAnimation,);
  }
