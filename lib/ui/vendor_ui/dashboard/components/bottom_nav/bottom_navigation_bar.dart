...
import 'package:psxmpc/ui/custom_ui/dashboard/components/bottom_nav/widgets/noti_nav_item.dart';
import 'package:psxmpc/ui/custom_ui/dashboard/components/bottom_nav/widgets/selected_noti_nav_item.dart';
            ...
            BottomNavigationBarItem(
              icon: Container(
                ...
                child: Icon(Remix.add_circle_line,
                    size: 45, color: Utils.isLightMode(context)
                    ? PsColors.achromatic500
                    : PsColors.achromatic100,),
              ),
              label: ''.tr,
