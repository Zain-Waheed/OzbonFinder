  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
        ...
        child: InkWell(
          ...
          child: Container(
            color:
                widget.isSelected ? Utils.isLightMode(context) ? PsColors.achromatic50 :PsColors.achromatic600  : Utils.isLightMode(context) ? PsColors.achromatic50 :PsColors.achromatic800 ,
            child: Column(
              children: <Widget>[
                Ink(
                  child: Row(
                      ...
                      Padding(
                        ...
                        child: Text(
                          ...
                          style: Theme.of(context)
                              .textTheme
                              .bodySmall!
                              .copyWith(color: Utils.isLightMode(context) ? PsColors.text500: PsColors.text50),
                        ),
                      ),
                    ],
                  ),
