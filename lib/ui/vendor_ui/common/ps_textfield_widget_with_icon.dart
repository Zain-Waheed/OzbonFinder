      ...
      children: <Widget>[
        Container(
          ...
          decoration: BoxDecoration(
            color: Utils.isLightMode(context) ? PsColors.achromatic100 : PsColors.achromatic900,
            ...
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color:Utils.isLightMode(context) ? PsColors.achromatic300 : PsColors.achromatic50),
                ),
                child: _productTextFieldWidget,
              ),
              Positioned(
