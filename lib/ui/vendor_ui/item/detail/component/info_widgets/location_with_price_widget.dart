...
class LocationWithPriceWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Product product = Provider.of<ItemDetailProvider>(context)
                              .product;
    ...
    return SliverToBoxAdapter(
      child: Container(
        margin:  EdgeInsets.only(
            ...
            right: Directionality.of(context) == TextDirection.rtl?PsDimens.space6:PsDimens.space14),
        child: Column(
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                Column(
                  children: <Widget>[
                    ...
                    Text(
                      Utils.getDateFormat(product.addedDate, psValueHolder.dateFormat!),
                  ...
                  children: <Widget>[
                    Row(
                      ...
                      children: <Widget>[
                        Icon(
                          Remix.map_pin_line,
                          color: Utils.isLightMode(context) ? PsColors.achromatic500 : PsColors.achromatic400,
                          size: 24,
                        ),
                        const SizedBox(
