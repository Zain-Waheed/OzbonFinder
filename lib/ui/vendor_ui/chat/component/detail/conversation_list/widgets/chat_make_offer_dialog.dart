...
class _ChatMakeOfferDialogState extends State<ChatMakeOfferDialog> {
  ...
  String? date;
  String? time;
  List<String> timeList = <String>['1:00 AM','2:00 AM','3:00 AM','4:00 AM','5:00 AM','6:00 AM','7:00 AM','8:00 AM',
                ...
                children: <Widget>[
                  ...
                  Text(
                    ...
                    style: Theme.of(context).textTheme.bodyLarge!.copyWith(
                        color: PsColors.primary500, fontWeight: FontWeight.bold),
                  ),
                  const SizedBox(
                    height: PsDimens.space4,
                  ),
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.end, children: <Widget>[
        ...
        Expanded(
          child: PSButtonWidgetRoundCorner(
            ...
            titleTextColor:Utils.isLightMode(context) ? PsColors.text900: PsColors.achromatic900,
            hasShadow: false,
            hasBorder: true,
