          ...
          children: <Widget>[
            Text(
              ...
              style: Theme.of(context)
                  .textTheme
                  .titleLarge
                  ?.copyWith(color: Utils.isLightMode(context) ? PsColors.text600 :PsColors.text50,),
              maxLines: 1,
            ),
            Container(
              // width: 50,
              child: Text(
                ...
                style: Theme.of(context)
                    .textTheme
                    .bodyLarge
                    ?.copyWith(color: Utils.isLightMode(context) ? PsColors.text600 :PsColors.text50, fontSize: 16),
                maxLines: 1,
              ),
            ),
          ],
