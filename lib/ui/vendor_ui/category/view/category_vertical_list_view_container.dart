...
import 'package:psxmpc/ui/vendor_ui/common/ps_back_button_with_circle_bg_widget.dart';
    ...
    return PsAppbarWidget(
      leading: InkWell(
        ...
        child:PsBackButtonWithCircleBgWidget(
          ...
          leftColor:(psValueHolder!.languageCode == 'ar')? PsColors.achromatic50.withAlpha(50): PsColors.achromatic50,
          rightColor:(psValueHolder!.languageCode == 'ar')? PsColors.achromatic50:PsColors.achromatic50.withAlpha(50)),
      ),
